...
[One or two sentences — what changed and why, in plain language, readable on its own without the rest of the comment. Name the user-visible outcome, not the implementation. Always rendered; never omitted.]
