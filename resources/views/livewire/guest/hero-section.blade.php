                ...
                <div class="terminal-output ml-4 mt-2">
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            <div class="hero-halo shrink-0">
                                <div class="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-primary overflow-hidden glow-border">
                            ...
                            <div>
                                <h1 class="text-2xl md:text-3xl font-bold text-foreground">
                                    {{ $name }} <span class="block text-lg md:text-xl text-primary font-mono mt-1 glow-text">{{ $role }}</span>
                                </h1>
                                <p class="hud-label mt-2" role="doc-subtitle">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <span class="hud-label flex items-center gap-1.5">
